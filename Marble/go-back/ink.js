...
class Drop {
  ...
  //     b.x += cos(a) * this.vTine(b.y, this.z, this.c, 1);
  //     b.y += sin(a) * this.vTine(b.x, this.z, this.c, 1);
  //   }
  // }
  ...
  north() {
    ...
    for (let i = 0; i < this.n; i++) {
      ...
      this.vtines.push(createVector(x, y));
      //console.log(this.vtines[3]);
    }
  }
  ...
  south() {
    ...
    for (let i = 0; i < this.n; i++) {
      ...
      this.htines.push(createVector(x, y));
    }
  }
